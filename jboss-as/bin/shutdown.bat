...
rem $Id: shutdown.bat 113276 2012-07-25 15:44:59Z csams $
...
set JBOSS_CLASSPATH=%JBOSS_CLASSPATH%;%MAIN_JAR%;%DIRNAME%/../client/jbossall-client.jar;%DIRNAME%/../lib/jboss-system-jmx.jar
